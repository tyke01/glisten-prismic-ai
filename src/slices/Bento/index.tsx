  ...
  return (
    ...
    >
      <PrismicRichText
        ...
        components={{
          heading2: ({ children }) => (
            <h2 className="text-balanced text-center text-5xl font-medium md:text-7xl">
              {children}
            </h2>
          ),
          em: ({ children }) => (
      ...
      <div className="mt-16 grid max-w-4xl grid-rows-[auto_auto_auto] gap-8 md:grid-cols-3 md:gap-10">
        {slice.primary.bento_cards.map((item) => (
          // Render the item
          <div
            className={clsx(
          ...
          >
            ...
            <div className="text-balanced max-w-md text-slate-300">
