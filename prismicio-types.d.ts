...
/**
 * Item in *Bento → Default → Primary → Bento cards*
 */
export interface BentoSliceDefaultPrimaryBentoCardsItem {
  /**
   * Title field in *Bento → Default → Primary → Bento cards*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_cards[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Bento cards*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_cards[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Bento cards*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_cards[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Bento cards*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.bento_cards[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Bento cards field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_cards[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  bento_cards: prismic.GroupField<
    Simplify<BentoSliceDefaultPrimaryBentoCardsItem>
  >;
}
...
/**
 * Item in *CaseStudies → Default → Primary → Case Studies Card*
 */
export interface CaseStudiesSliceDefaultPrimaryCaseStudiesCardItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Case Studies Card*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.case_studies_card[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Case Studies Card field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.case_studies_card[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  case_studies_card: prismic.GroupField<
    Simplify<CaseStudiesSliceDefaultPrimaryCaseStudiesCardItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBentoCardsItem,
      BentoSliceDefaultPrimary,
      BentoSliceVariation,
      BentoSliceDefault,
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryCaseStudiesCardItem,
